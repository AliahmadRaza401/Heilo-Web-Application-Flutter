                      ...
                      child: Row(
                        ...
                        children: [
                          CircularPercentIndicator(
                            ...
                            lineWidth: 5,
                            percent: 0.2,
                            center: Text("20%",style: TextStyle(fontSize: 35.sp),),
                          ...
                          CircularPercentIndicator(
                            ...
                            lineWidth: 5,
                            percent: 0.5,
                            center: Text("50%",style: TextStyle(fontSize: 35.sp),),
        ...
        children: [
          Positioned(
            ...
            child: Container(
                ...
                padding:
                    EdgeInsets.only(top: 5, left: 5, right: 5, bottom: 2),
          ...
          Container(
            ...
            child: Center(
              child: text(context, 'Upcoming Sessions', 20.sp, AppColors.greyText),
            ),
          ),
          // Positioned(
          //   right: 40,
        ...
        child: Row(
          children: [
            Container(
                ...
                child: Center(
                  child:
                      text(context, '27th July, 2021',12.sp, AppColors.greyText),
                )),
            SizedBox(
