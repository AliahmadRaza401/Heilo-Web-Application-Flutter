...
class TeacherWalletWeb extends StatefulWidget {
  const TeacherWalletWeb({Key? key}) : super(key: key);

  @override
  State<TeacherWalletWeb> createState() => _TeacherWalletWebState();
}

class _TeacherWalletWebState extends State<TeacherWalletWeb> {
  @override
