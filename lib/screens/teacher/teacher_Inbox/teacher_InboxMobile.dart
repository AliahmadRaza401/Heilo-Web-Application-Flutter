...
class TeacherInboxMobile extends StatefulWidget {
  ...
  @override
  State<TeacherInboxMobile> createState() => _TeacherInboxMobileState();
}

class _TeacherInboxMobileState extends State<TeacherInboxMobile> {
  @override
    ...
    return InkWell(
      onTap: () {
         Navigator.of(context).push(
                  MaterialPageRoute(builder: (context) => TeacherChatMain()));
      },
      child: Container(
        decoration: const BoxDecoration(
          color: Color(0xffF8F8F8),
